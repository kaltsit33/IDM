...
\section{Introduction}
   ...
   explaining the accelerated expansion of the Universe (\cite{Riess_1998}; \cite{Perlmutter_1999}), 
   from the cosmic microwave background (CMB) anisotropies (\cite{Bennett_1996}) to 
   the measurement of baryon acoustic oscillations (BAO; \cite{Eisenstein_2005}). However, there are also many 
   alternative models that have been proposed to explain, such as the dynamical
