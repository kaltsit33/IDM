...
\subsection{Model 1: mimicking the ΛCDM model}
   ...
   \begin{figure}[htbp]
      \centering
      \subfigure{
         \includegraphics[width=0.22\textwidth]{compare_1.pdf}
      }
      \subfigure{
         \includegraphics[width=0.22\textwidth]{compare_2.pdf}
      }
   ...
   \begin{figure}[htbp]
      ...
      \caption{The constraint result from the SNe Ia + OHD data.}
   \end{figure}
   ...
   \begin{figure}[htbp]
      ...
      \caption{The constraint result from the BAO + SNe Ia + OHD data.}
      \label{fig:5}
   \end{figure}
   ...
   Fig \ref{fig:6} shows the difference between classical dataset ($H(z)$, SNe Ia)
   and newly released BAO dataset. The BAO dataset gives a strict constraint to
   $\Omega_{2,0} \simeq 0.3$, lower than the SNe Ia dataset about $3\sigma$, which
   gives a higher value $\Omega_{2,0} \simeq 0.4$. The constraint result to Pantheon+
   SNe Ia dataset in $\Lambda$CDM model is $\Omega_M \simeq 0.33$ (\cite{Borghi_2022}),
