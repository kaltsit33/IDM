...
\subsection{Model 1: mimicking the ΛCDM model}
   ...
   \begin{figure*}
      ...
      \subfigure{
         \includegraphics[width=0.3\textwidth]{bao_1.pdf}
      }
      \subfigure{
      ...
      \subfigure{
         \includegraphics[width=0.3\textwidth]{bao_2.pdf}
      }
      \subfigure{
...
\subsection{Model 2: mimicking the wCDM model}
   ...
   \begin{figure*}
      ...
      \subfigure{
         \includegraphics[width=0.3\textwidth]{bao_widm_1.pdf}
      }
      \subfigure{
      ...
      \subfigure{
         \includegraphics[width=0.3\textwidth]{bao_widm_2.pdf}
      }
      \subfigure{
