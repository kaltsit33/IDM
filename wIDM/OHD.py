...
def main():
    ...
    initial = np.array([0.2, 0, 70]) # expected best values
    ...
    g.export('./article/pictures/ohd_widm.pdf')
    ...
    g.plot_2d(samples_2, 'O20', 'n', filled=True, colors=['b'])
    ...
    g.settings.axes_fontsize = 18
    g.settings.axes_labelsize = 24
    g.plot_2d(samples_, 'O20', 'wIDM', filled=True, colors=['b'])
