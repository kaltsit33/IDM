...
def lnlike(paras):
    ...
    chi2 = chi_square_OHD(log_kC1, O20, n, H0) + chi_square_SNe(log_kC1, O20, n, H0) + chi_square_BAO(log_kC1, O20, n, H0, rdh)
    return -0.5 * chi2
...
def main():
    ...
    np.savetxt('./wIDM/new/output/m3.dat', flat_samples)
